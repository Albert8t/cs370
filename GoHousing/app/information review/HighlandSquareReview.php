    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-10">
                ...
                <h2 class="heading">Highland Square</h2>
            </div>
        </div>
    </div>
</div>
...
print("<div class = \"reviewtitle\">
    <div class = \"reviewinput\">
        <form form class = \"form-login\"  ACTION=\"HighlandSquareReview.php\" METHOD=\"POST\">
            <h3>Please fill in your reviews</h3>

            <p>Your reviews help other learn about Highland Square.</p>
            <textarea name= \"review\" rows=\"5\" cols=\"105\"></textarea>
            <br>
            <p>Give A Rate Of Highland Square From 0 to 10 </p>
...
<div class = \"gapbetween\">
    <div class=\"row mb-5\">
        <div class=\"col-md-7 section-heading\">
            ...
            <h3>Here are the reviews for Highland Square</h3>
        </div>
    </div>
</div>");
...
if($_POST['give']) {
    ...
    $insert = "insert into review (user,house,context,rating)  values('" . $name . "','" . "HighlandSquare" . "','" . $_POST['review'] . "','" . $_POST['points'] . "')";
...
$ifExist = "select * from review where house='HighlandSquare';";
