    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-10">
                ...
                <h2 class="heading">Gables Emory Point</h2>
            </div>
        </div>
    </div>
</div>
...
print("<div class = \"reviewtitle\">
    <div class = \"reviewinput\">
        <form form class = \"form-login\"  ACTION=\"GablesReview.php\" METHOD=\"POST\">
            ...
            <br>
            <p>Give A Rate Of Gables Emory Point From 0 to 10 </p>
...
<div class = \"gapbetween\">
    <div class=\"row mb-5\">
        <div class=\"col-md-7 section-heading\">
            ...
            <h3>Here are the reviews for Gables Emory Point</h3>
        </div>
    </div>
</div>");
...
if($_POST['give']) {
    ...
    $insert = "insert into review (user,house,context,rating)  values('" . $name . "','" . "EmoryPoint" . "','" . $_POST['review'] . "','" . $_POST['points'] . "')";
...
$ifExist = "select * from review where house='EmoryPoint';";
